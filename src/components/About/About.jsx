        ...
        <div className="about">
            <div className="about__intro about__text">
                <div className="about__image-block">
                    ...
                    <div className="about__portrait--underlay"></div>
                </div>
                <div className="about__text-block">
                    ...
                    <p>What drew me to web design was my problem solving skills - I love a good design challenge and web development is an especially great area for finding creative solutions to a client's problem.</p> 
            ...
            <div className="about__history about__text">
                <div className="about__image-block">
                    <div className="about__history-img--overlay">
                      <div className="about__history-img"></div>
                    </div>
                    <div className="about__history-img--underlay"></div>
                </div>
                <div className="about__text-block">
                    <h2>History</h2>
            ...
            <div className="about__career about__text">
                <div className="about__text-block">
                    ...
                    <p>When I graduated I worked as a contract graphic designer, before landing a job as a digital and creative marketing specialist in the print industry. This only helped accentuate my knowledge of graphic design, and allowed me to work building and modifying Shopify and WordPress websites. Inspired by the surprising amount of web work involved, I went back to school again to take a web development bootcamp at <a href="https://brainstation.io">BrainStation</a>.</p>
                    <p>From there I was hired on as a Teaching Assistant within the program, and continued to develop my coding knowledge. I was also working on a Wix based website for the <a href="https://westcoastknitters.org">West Coast Knitters' Guild</a>, which was a super fun project to learn the Wix system.</p>
                </div>
            </div>
            ...
            <div className="about__current about__text">
                <div className="about__text-block">
                    <h2>Current Day</h2>
                    <p>Now-a-days I can be found playing with my cat Toc, taking more react learning courses, knitting up a storm, dying wool, playing with linocuts and screen printing, and occasionally crafting leather armour.</p>
                </div> 
            </div>
        </div>
    )
